    ...
    return(
        <>
            <div className="container" style={{color: props.mode==='dark'?'white':'#042743'}}>
                ...
                <button className="btn btn-primary mx-1" onClick={LowerCase}>Convert to LoweCase</button>
                <button className="btn btn-primary mx-1" onClick={RemoveExtraSpace}>Remove Extra Space</button>
                <button className="btn btn-primary mx-1" onClick={CopyText}>Copy All Text</button>
                <button className="btn btn-primary mx-1" onClick={ClearText}>Clear Text</button>
            </div>
            <div className='container my-3' style={{color: props.mode==='dark'?'white':'#042743'}}>
                <h4 className="py-4"> {text.split(" ").length-1} Words and {text.length} characters</h4>
